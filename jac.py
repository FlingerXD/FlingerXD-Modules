...
class JacquesMod(loader.Module):
	"""Жаконизатор"""
	strings = {
		'name': 'Катлета Флингера',
		'usage': 'ТАК СЛОЖНО НАПИСАТЬ <code>(Ты еблан).help Жаконизатор</code> , ДОЛБАЕБ?',
	}
	def __init__(self):
	...
	async def jcmd(self, message):
		...
		pic = requests.get("https://github.com/FlinGer-TermuX/FlinGerFTG_Modules/blob/master/zhak-fresko-memy-1.jpg?raw=true")
